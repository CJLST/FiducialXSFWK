...
def plotXS(obsName, obs_bins, chan, obs_bins_boundaries = False):
    ...
    if (opt.UNBLIND): _temp = __import__('resultsXS_LHScan_observed_'+obsName+'_v4'+floatfix, globals(), locals(), ['resultsXS'], 0)
    else: _temp = __import__('resultsXS_LHScan_expected_'+obsName+'_v4'+floatfix, globals(), locals(), ['resultsXS'], 0)
    ...
    #            ggH_aMC_NLOunc_lo[obsBin]+=sqrt(total_NLOunc_fs_aMC_lo)
        ...
        if chan == '4l':
            if (opt.UNBLIND):
                ...
                #data_hi[obsBin] = resultsXS_LHScan["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerUp"]
                #data_lo[obsBin] = -1.0*resultsXS_LHScan["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerDn"]
            else:
            ...
            if (opt.UNBLIND):
                # modeldep_hi[obsBin] = modelIndUncert["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerUp"]
                # modeldep_lo[obsBin] = -1.0*modelIndUncert["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerDn"]
                ...
                #systematics_hi[obsBin] = sqrt(max(0.0,resultsXS_LHScan["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_LHScan["SM_125_"+obsName+"_4l_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
                #systematics_lo[obsBin] = sqrt(max(0.0,resultsXS_LHScan["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_LHScan["SM_125_"+obsName+"_4l_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))
            else:
                # modeldep_hi[obsBin] = modelIndUncert["AsimovData_"+obsName+"_4l_genbin"+str(obsBin)]["uncerUp"]
                # modeldep_lo[obsBin] = -1.0*modelIndUncert["AsimovData_"+obsName+"_4l_genbin"+str(obsBin)]["uncerDn"]
                systematics_hi[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS["SM_125_"+obsName+"_4l_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
                systematics_lo[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_4l_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS["SM_125_"+obsName+"_4l_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))
            ...
            if (opt.UNBLIND):
                ...
                #data_hi[obsBin] = resultsXS_LHScan["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerUp"]
                #data_lo[obsBin] = -1.0*resultsXS_LHScan["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerDn"]
            else:
            ...
            if (opt.UNBLIND):
                # modeldep_hi[obsBin] = modelIndUncert["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerUp"]
                # modeldep_lo[obsBin] = -1.0*modelIndUncert["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerDn"]
                ...
                #systematics_hi[obsBin] = sqrt(max(0.0,resultsXS_LHScan["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_LHScan["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
                #systematics_lo[obsBin] = sqrt(max(0.0,resultsXS_LHScan["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_LHScan["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))
            else:
                # modeldep_hi[obsBin] = modelIndUncert["AsimovData_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerUp"]
                # modeldep_lo[obsBin] = -1.0*modelIndUncert["AsimovData_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerDn"]
                systematics_hi[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
                systematics_lo[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS["SM_125_"+obsName+"_2e2mu_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))
    ...
    else: # the offset is used to slightly shift the bin centers when constructing alternative versions of an observable variable
    ...
    if (obsName=="pT4l"):
        ...
        label = "#Delta#Phi_{jj}"
        unit = ""
    elif obsName=="absdetajj_mjj":
        label = "|#Delta#eta_{jj}|"
        label_2nd = "m_{jj}"
        unit = ""
        unit_2nd = "GeV" 
    elif obsName=="ZZPt_njets_pt30_eta4p7":
        label = "p_{T}^{H}"
        label_2nd = "N_{jets}"
        unit = "GeV"
        unit_2nd = ""
    ...
    label_2e2mu = label+'(2e2#mu)' #MODELV4
    ...
    if(opt.SETLOG):
        ...
        elif 'costheta' in obsName: dummy.SetMaximum(5) #QUI
    ...
    if not acFlag:
        #legend . AddEntry(g_ggH_aMC , "gg#rightarrowH (amcatnloFXFX + JHUGen + Pythia) + XH", "lf") # spencer
        legend . AddEntry(g_ggH_minloHJ , "ggH (NNLOPS + JHUGen + Pythia) + XH", "l")
        legend . AddEntry(g_ggH_powheg , "ggH (POWHEG + JHUGen + Pythia) + XH", "l")
    ...
    if acFlag:
        ...
        #h_ggH_aMC.Draw("histsame") # spencer
    ...
    if acFlag:
        ...
        #g_ggH_aMC.Draw("5same") # spencer
        #g_ggH_aMCBorder.Draw("5same") # spencer
    ...
    latex2.DrawLatex(0.30, 0.94, "Private")
    ...
    if (obsName=="pT4l"):
        ...
        #latex2.DrawLatex(0.92, 0.71,"#frac{1}{50} #sigma(p_{T}^{H} > 200 GeV)") # spencer
    elif (obsName=="pTj1"):
    ...
    if obsName == 'pT4l':
        ...
        dummy2.GetYaxis().SetRangeUser(0.2,1.85) #QUI - changes the ratio plot y axis
    elif obsName == 'costhetaZ1':
    ...
    c.SaveAs('plots/'+obsName+'/'+subdir+'/'+obsName+'_unfoldwith_'+chan+'_'+datamodel+set_log+'_'+year+'.pdf')
    c.SaveAs('plots/'+obsName+'/'+subdir+'/'+obsName+'_unfoldwith_'+chan+'_'+datamodel+set_log+'_'+year+'.png')
    c.SaveAs('plots/'+obsName+'/'+subdir+'/'+obsName+'_unfoldwith_'+chan+'_'+datamodel+set_log+'_'+year+'.root')
    c.SaveAs('plots/'+obsName+'/'+subdir+'/'+obsName+'_unfoldwith_'+chan+'_'+datamodel+set_log+'_'+year+'.C')
...
'absdetajj_mjj': '0.89', # spencer - i made this up (0.97x0.92)    
'ZZPt_njets_pt30_eta4p7': '0.24' # spencer - i made this up
}

#print('obs_bins', obs_bins)
for c in ['4l', '2e2mu']: #MODELV4
