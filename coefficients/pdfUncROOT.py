...
def parseOptions():
    ...
    parser.add_option('',   '--obsName',dest='OBSNAME',    type='string',default='pT4l',   help='Name of the observalbe, supported: "ZZMass", "pT4l", "massZ2", "rapidity4l", "cosThetaStar", "nets_reco_pt30_eta4p7"')
...
if opt.NNLOPS:
    List = ["ggH125_NNLOPS"]
    root_file = ROOT.TFile("/eos/user/a/atarabin/MC_samples/2016UL/ggH125_NNLOPS/ggH125_NNLOPS_NNLOPS_reducedTree_MC_2016.root", "READ")
    Tree["ggH125_NNLOPS"] = root_file.Get("candTree")
    sample_shortnames["ggH125_NNLOPS"] = "ggH125_NNLOPS"
else:
    List = ["ggH125"]
    root_file = ROOT.TFile("/eos/user/a/atarabin/MC_samples/2016UL/ggH125/ggH125_unc_reducedTree_MC_2016.root", "READ")
