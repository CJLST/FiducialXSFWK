...
def createXSworkspace(obsName, channel, nBins, obsBin, observableBins, addfakeH, modelName, physicalModel, year, JES, doubleDiff, lowerBound, upperBound, rawObsName):
    ...
    if '2022' in year:
        ...
        massParaMap = readParam('/eos/home-s/sellissp/HZZ/RUNIII/CMSSW_14_1_0_pre4/src/FiducialXSFWK_HZZRun3/fit/param/sim_massParam_ggH_105160_'+channel+'_'+year+'.txt') # spencer
    else:
        ...
        massParaMap = readParam('/eos/home-s/sellissp/HZZ/RUNIII/CMSSW_14_1_0_pre4/src/FiducialXSFWK_HZZRun3/fit/param/sim_massParam_ggH_105160_'+channel+'_'+year+'_update.txt') # spencer
